...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/how-do-i-authenticate-with-cypher-shell-without-specifying-the-username-and-password-on-the-command-line-4nfUMcx.png[image,width="200",height="400"]

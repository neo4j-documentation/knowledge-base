...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/heapdump_overview.png[image,role="popup-link"]

It will open a new tab with the list of all the elements.

image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/heapdump_expand_outgoing_references.png[image,role="popup-link"]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/heapdump_cypher_string.png[image,role="popup-link"]

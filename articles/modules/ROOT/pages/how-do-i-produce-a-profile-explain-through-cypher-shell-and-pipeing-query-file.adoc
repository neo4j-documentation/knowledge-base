= How do I produce a profile/explain through cypher-shell and piping query file
:slug: how-do-i-produce-a-profile-explain-through-cypher-shell-and-piping-query-file
:author: Dana Canzano

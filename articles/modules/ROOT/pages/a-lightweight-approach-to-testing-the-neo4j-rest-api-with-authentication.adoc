...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-lightweight-approach-to-testing-the-neo4j-rest-api-with-authentication-qq4KTt1.png[image]
...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-lightweight-approach-to-testing-the-neo4j-rest-api-with-authentication-Zl1Bciq.png[image]
...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-lightweight-approach-to-testing-the-neo4j-rest-api-with-authentication-9wnIEUs.png[image]

Clicking *[OK]* should then return you back to a display similar to

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-lightweight-approach-to-testing-the-neo4j-rest-api-with-authentication-D5ut2II.png[image]

Finally, clicking **[SEND]** will submit the request.
You should see output similar to the following:

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-lightweight-approach-to-testing-the-neo4j-rest-api-with-authentication-cFIYTQW.png[image]

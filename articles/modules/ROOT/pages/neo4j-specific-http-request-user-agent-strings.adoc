...
For those https://neo4j-contrib.github.io/neo4j-apoc-procedures/[APOC] commands that retrieve data using HTTP/HTTPS,
and or running Cypher https://neo4j.com/docs/developer-manual/3.3/cypher/clauses/load-csv/[LOAD CSV]

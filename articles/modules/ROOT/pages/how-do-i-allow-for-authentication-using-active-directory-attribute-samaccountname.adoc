...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/how-do-i-allow-for-authentication-using-active-directory-attribute-samaccountname-pvwz7JY.png[image]

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/how-do-i-allow-for-authentication-using-active-directory-attribute-samaccountname-fCNzjvr.png[image,width=370]

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/how-do-i-allow-for-authentication-using-active-directory-attribute-samaccountname-bsF7qi6.png[image,width=370]

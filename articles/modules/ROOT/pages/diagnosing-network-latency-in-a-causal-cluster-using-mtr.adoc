...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/a-simple-mtr-trace.png[A simple MTR trace]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/tcp-mtr-trace-from-source-port.png[TCP MTR trace from source port]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/intra-cluster-mtr-trace.png[Intra-cluster MTR trace]

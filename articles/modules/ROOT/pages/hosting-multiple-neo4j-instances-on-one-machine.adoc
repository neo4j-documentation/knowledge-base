...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/cpu-profile.png[CPU Profile]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/memory-profile.png[Memory Profile]
...
Peak expected growth total for each instances should never increase beyond available disk space (here is a good reference about transaction log growth and rotation: https://neo4j.com/docs/operations-manual/3.4/configuration/transaction-logs/).

...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/list-of-available-cpu-cores.png[List of available CPU cores]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/cpu-cores-affinity-list-for-the-process.png[CPU cores affinity list for the process]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/updated-cpu-cores-which-the-process-is-affiliated-with.png[Updated CPU cores which the process is affiliated with]

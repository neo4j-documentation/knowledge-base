...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/using-apoc-load-jsonparams-to-load-data-from-zendesk-into-neo4j-to-learn-about-article-subscribers-Kp38cGv.png[image,width=460]

The entire graph thus appears as

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/using-apoc-load-jsonparams-to-load-data-from-zendesk-into-neo4j-to-learn-about-article-subscribers-VNJCeBO.png[image,width=460]

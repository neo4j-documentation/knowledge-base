...
:neo4j-versions: 3.1, 3.2, 3.3, 3.4, 3.5, 4.1, 4.2
...
Alternately, the APOC Procedures library includes procedures designed for https://neo4j.com/labs/apoc/4.2/cypher-execution/conditionals/[conditional Cypher execution].

...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/configure-neo4j-multiple-ous-using-active-directory-attribute-samaccountname-5Bf1aG3.png[image]

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/configure-neo4j-multiple-ous-using-active-directory-attribute-samaccountname-HDwq9Vi.png[image]

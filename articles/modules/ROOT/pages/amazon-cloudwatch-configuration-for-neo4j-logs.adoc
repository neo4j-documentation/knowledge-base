...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/amazon-cloudwatch-configuration-for-neo4j-logs-Zm39Ni1.png[image]

Selecting the `/neo4j/logs` group brings you to a page to select your logstream:

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/amazon-cloudwatch-configuration-for-neo4j-logs-rNNfSh4.png[image]

Finally, you can select on the server id and view the actual log file:

image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/amazon-cloudwatch-configuration-for-neo4j-logs-cUb50JD.png[image]
...
image:https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/amazon-cloudwatch-configuration-for-neo4j-logs-Vf6iEPL.png[image]

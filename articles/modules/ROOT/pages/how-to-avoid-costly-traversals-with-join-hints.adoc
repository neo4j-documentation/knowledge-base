...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/without-join-hint.png[image,role="popup-link"]
...
image::https://s3.amazonaws.com/dev.assets.neo4j.com/kb-content/with-join-hint.png[image,role="popup-link"]
